      ...
      <div class="para">
        ...
        <div class="para-cntnt">
          <figure class="post-figure">
            ...
            <figcaption><a target="_blank" href="http://test.casit.co.kr/15">씨에이에스 - 데이터품질인증센터</a></figcaption>
          </figure>
        </div>
      </div>
      <div class="para">
...
<div class="refr-wrap">
  ...
  <ol class="refr-list">
    ...
    <li>(씨에이에스) <a target="_blank" href="http://test.casit.co.kr/15">데이터품질인증센터</a></li>

...
<div class="post-wrap">
  <div class="para">
    <div class="para-title">
      I. 마이크로프로세서와 저속 주변장치 사이의 통신을 용도로 필립스사가 개발한 규격
    </div>
    <div class="para-cntnt">
      <div class="para">
        <div class="para-title">
          가. I2C(Inter Integrated Circuit)의 정의
        </div>
        <div class="para-cntnt">
  ...
  <div class="para">
    ...
    <div class="para-cntnt">
      <div class="para">
        <div class="para-title">
          가. I2C(Inter Integrated Circuit)의 아키텍처
        </div>
        <div class="para-cntnt">
...
<!--            <figcaption>Source: Unveiling the Metaverse: Exploring Emerging Trends, Multifaceted Perspectives, and Future Challenges</figcaption>-->
      ...
      <div class="para">
        <div class="para-title">
          나. I2C(Inter Integrated Circuit)의 구성요소
        </div>
        <div class="para-cntnt">
